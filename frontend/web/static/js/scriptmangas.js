...
function getMangaData(mangaId) {
  $.ajax({
    ...
    success: function (response) {
      // Mostrar los datos del manga en la página
      var mangaId = response.manga.id;
      var mangaTitle = response.manga.nombre;
      var mangaPrecio = response.manga.precio;
      console.log(response.manga)

      // Agregar fila a la tabla cart-items dentro del modal
